...
int main() {
    ...
    const auto snapshot = bybit_v5::decode(R"({"topic":"orderbook.50.BTCUSDT","type":"snapshot","data":{"s":"BTCUSDT","b":[["100.25","2"],["100.00","1.5"]],"a":[["100.50","3"]],"u":10,"seq":20,"cts":123}})");
    ...
    const auto delta = bybit_v5::decode(R"({"topic":"orderbook.50.BTCUSDT","type":"delta","data":{"b":[["100.25","0"]],"a":[["100.40","4"]],"u":11,"seq":21,"cts":124}})");

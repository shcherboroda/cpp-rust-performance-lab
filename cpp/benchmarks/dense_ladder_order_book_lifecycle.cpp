...
using llab::dense_ladder_order_book::Event;
using llab::dense_ladder_order_book::EventType;
using llab::dense_ladder_order_book::OrderBook;
using llab::dense_ladder_order_book::Side;
...
int main(int argc, char **argv) {
    ...
    std::cout << "benchmark: dense_ladder_order_book_lifecycle_churn_v3\n";
